---
title: "Inference Project_1"
output: html_document
---


The following report is submitted for Statistical Inference Course project part-1.

Overview

The exponential distribution can be simulated in R with rexp(n, lambda) where lambda ?? is the rate parameter. The mean of the exponential distribution is 1/?? and the standard deviation is also 1/??. For this simulation, we set ??=0.2. And we investigate the distribution of averages of 40 samples drawn from the exponential distribution with ??=0.2.
```{r}
